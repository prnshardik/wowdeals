				...
				<div class="page-header">
					...
					<ul class="app-actions">
						<div class="custom-search">
							<input type="text" class="search-query" placeholder="Enter State Name">
							<i class="icon-search1"></i>
						</div>
						<li>
							<a href="#" data-toggle="modal" data-target="#addNewContact">
								<i class="icon-circle-with-plus" data-toggle="tooltip" data-placement="top" title="Add New State"></i>
							</a>
						</li>
					</ul>
